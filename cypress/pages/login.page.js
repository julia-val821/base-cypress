...
class LoginPage extends BasePage{
  ...
  get buttonSignIn () { return cy.get('.ant-btn-primary') }
  ...
  get passwordValidation () { return cy.xpath('//div[contains(@class, "ant-form-item-has-error")][.//input[@id="normal_login_email"]]//div[@class="ant-form-item-explain-error"]') }
